...
export default function Button({
  ...
  return (
    <button
      {...rest}
      className={cls(
        "w-full bg-violet-900 hover:bg-emerald-300 text-white  px-4 border border-transparent rounded-md shadow-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none",
